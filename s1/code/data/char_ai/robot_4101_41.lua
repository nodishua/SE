robot_4101_41=
{
	...
	init=function(char_type, char_key_1, char_key_2)
		...
		--设置出生点
		SetPos(char_type, char_key_1, char_key_2, robot_4101_41.born_x, robot_4101_41.born_y, 0);
	...
	timeout=function(char_type, char_key_1, char_key_2, time_sec, time_m_sec)
		...
		if ai_state == 0 then
			robot_4101_41.ProcessBorn(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 1 then
			robot_4101_41.ProcessStand(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 2 then
			robot_4101_41.ProcessPatrol(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 3 then
			robot_4101_41.ProcessWalk(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 4 then
			robot_4101_41.ProcessRunAway(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 5 then
			robot_4101_41.ProcessGoBack(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 6 then
			robot_4101_41.ProcessFighting(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 7 then
			robot_4101_41.ProcessFlow(char_type, char_key_1, char_key_2, ai_state);
		end;
	end;
	...
	ProcessFighting=function(char_type, char_key_1, char_key_2, cur_state)
		...
		if CastSkillCheck(char_type, char_key_1, char_key_2, 4021, 1) == 0 then
			CastSkill(char_type, char_key_1, char_key_2,
			tar_char.char_type, tar_char.character_id_1, tar_char.character_id_2,
			4021, 1);
			return;
