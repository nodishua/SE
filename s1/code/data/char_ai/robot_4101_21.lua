robot_4101_21=
{
	...
	init=function(char_type, char_key_1, char_key_2)
		...
		--设置出生点
		SetPos(char_type, char_key_1, char_key_2, robot_4101_21.born_x, robot_4101_21.born_y, 0);
	...
	timeout=function(char_type, char_key_1, char_key_2, time_sec, time_m_sec)
		...
		if ai_state == 0 then
			robot_4101_21.ProcessBorn(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 1 then
			robot_4101_21.ProcessStand(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 2 then
			robot_4101_21.ProcessPatrol(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 3 then
			robot_4101_21.ProcessWalk(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 4 then
			robot_4101_21.ProcessRunAway(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 5 then
			robot_4101_21.ProcessGoBack(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 6 then
			robot_4101_21.ProcessFighting(char_type, char_key_1, char_key_2, ai_state);
		elseif ai_state == 7 then
			robot_4101_21.ProcessFlow(char_type, char_key_1, char_key_2, ai_state);
		end;
	end;
	...
	ProcessPatrol=function(char_type, char_key_1, char_key_2, cur_state)
		...
		if tar_char.character_id_1 ~= 0 then
			if CheckCharDistance(char_type, char_key_1, char_key_2, tar_char.char_type, tar_char.character_id_1, tar_char.character_id_2, 70) == 0 then
	...
	ProcessFighting=function(char_type, char_key_1, char_key_2, cur_state)
		...
		if CastSkillCheck(char_type, char_key_1, char_key_2, 2021, 1) == 0 then
			CastSkill(char_type, char_key_1, char_key_2,
			tar_char.char_type, tar_char.character_id_1, tar_char.character_id_2,
			2021, 1);
			return;
