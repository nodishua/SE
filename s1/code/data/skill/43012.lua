  ...
  --------------------------------------------------------------------------------------
    appears= --释放表现
	{
		...
		};--]]
		{
			...
			npctype=8002521;	--npctype和npcname如果配了的话，就走半身像飞入的说话方式，如果没配的话就走头上冒泡泡的方式
			npcname=ds(230246);
			dialog=ds(230189);
			offsettime=0;
			lifetime=2;
	...
	[1]={			--预警弹道
		...
		[3]={
            ...
            bullets=
            {
                ...
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 7.0; --弹道原点离释放者多远 近战一般都是0
				    originRotation = 0; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
                    regionType = 2; --1扇形 2圆形 3矩形
                    radius = 2.5; --半径 圆形扇形区域用到的
                    angle = 0; --扇形的角 扇形专用
		...
		[4]={ --持续迁移弹道
            ...
            bullets=
            {
                ...
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 1.5; --弹道原点离释放者多远 近战一般都是0
				    originRotation = 0; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
...
thisconfig=SkillServerConfig[43012];