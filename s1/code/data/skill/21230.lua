SkillServerConfig[21230]=
{
	...
	movelimit =3; --行动硬直
	attacklimit =3; --攻击硬直
	svrmovelimit = 3;  --服务器用到的行动硬直
	svrattacklimit = 3; --服务器用到的行动硬直
    baseSpeed = 1.2;
	...
	appears= --释放表现
	{
		...
		
		{
			...
			damp = 0.2; --阻尼，振幅函数是X=A*cos(φ(t)+a)*e^(-damp*t)，默认是1
		};
	};	
	------------------------------------------------------------------------------------------
...
thisconfig=SkillServerConfig[21230]; 