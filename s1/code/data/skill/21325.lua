SkillServerConfig[21325]=
{
	...
	movelimit =  0.8 / 1.5, --行动硬直
	attacklimit = 1.0,--攻击硬直
	svrmovelimit = 0.8,  --服务器用到的行动硬直
	svrattacklimit = 1.0,  --服务器用到的行动硬直
...
thisconfig=SkillServerConfig[21325];