SkillServerConfig[2022111]=
{
	...
	Leadtime = 0 ; --引导时间
	cdtype = 2022111 ; --CD类型，相同类型的技能共CD
	cd = 0 ; --CD时间
	sharecd = 0 ; --共享冷却类型
		...
		[1]=
		{
			...
			bullets=
			{
				[1]=
				{
					...
					radius = 7.2; --半径 圆形扇形区域用到的
					angle = 0; --扇形的角 扇形专用
					width = 1.8;--如果是矩形 radius 就是矩形人朝向方向的长度 width就是横向宽度    
					...
					mapEffect =
					{
                        moveDis = 0;
						offset = 0;
						lifetime = 1;	--这个要和弹道的moveTime, 否则速度回对不上
						id = 2029;
						scale = 1.0;	----缩放比例
						rotation = 0;
					...
					{
						{
							...
							lifetime=1.0;
							id=500205;
							attachname="actorroot";--actorroot
						};
					};
				};
			};
...
thisconfig=SkillServerConfig[2022111];