SkillServerConfig[21156]=
{
	...
	movelimit =  1.6; --行动硬直
	attacklimit = 1.6;--攻击硬直
	svrmovelimit = 1.6,  --服务器用到的行动硬直
	svrattacklimit = 1.6,  --服务器用到的行动硬直
...
thisconfig=SkillServerConfig[21156];