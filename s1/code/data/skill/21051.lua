	...
	hits={
		...
		[2]={			--伤害弹道，预警特效出现之后，等下出黑暗手和伤害
            ...
            bullets=
            {
                ...
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 2.15; --弹道原点离释放者多远 近战一般都是0
		...
		[5]={			--伤害弹道，预警特效出现之后，等下出黑暗手和伤害
            ...
            bullets=
            {
                ...
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 6.4; --弹道原点离释放者多远 近战一般都是0
                    ...
                    moveTime = 0.35; --弹道运行时间
                    moveDistance = 4.3; --弹道运行长度 如果是0 表示在原点不动
                    singleTargetHitMax = 1; --这个弹道能对单个单位造成多少次伤害
                    shiftmove = 1.2;--被击位移距离
					shifttime = 0.3;--位移时间 --客户端用
                    shiftrotation = 0; --位移默认方向是从施法者到被击者连线方向 加个旋转参数，角度、顺时针正数，逆时针负数			
...
thisconfig=SkillServerConfig[21051];