...
SkillServerConfig[10201]=
{
   ...
   -- autoChooseDistanceMax = 8; --这里就配第一个弹道的originDistance就行了
		...
		[1]={
            ...
            bullets=
            {
                [1]= -- 这个弹道效果是用来打人和灵兽的
                {
                    ...
                    angle = 0; --扇形的角 扇形专用
                    bulletType = 1; --弹道类型（0直线弹道，1追踪弹道，2追踪群攻弹道（目标位置为原点），3弧形弹道）
                    moveRotation = 0; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
                    moveTime = 1; --弹道运行时间
                    moveDistance = 10; --弹道运行长度 如果是0 表示在原点不动,追踪弹道的运行长度/运行时间是这个弹道的移动速度，追踪弹道的范围由baseaction的境界范围决定
...
thisconfig=SkillServerConfig[10201];