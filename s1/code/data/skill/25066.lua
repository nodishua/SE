SkillServerConfig[25066]=
{
    id = 25066;
    name = "净灵-黑虎-白虎右抓（百分比伤害）";
    image = "";
    --攻击位移
			...
			bullets=
			{
				[1]=
				{
					...
					mapEffect =				--预警配置
					{
						...
						scale = 10;		--缩放比例，扇形和圆形直接配缩放的值大小，矩形需要配=Vector3.New(x,1,z)x是横向，z是竖向，y不用管
...
thisconfig=SkillServerConfig[25066];