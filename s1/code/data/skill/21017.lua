SkillServerConfig[21017]=
{
	...
	autoChooseDistanceMax = 30; --这里就配第一个弹道的originDistance就行了
		...
		[1]={			--表现弹道，地面先出的预警特效
			...
			bullets=
			{
				[1]=
				{
					...
					originDistance = 30; --弹道原点离释放者多远 近战一般都是0
...
thisconfig=SkillServerConfig[21017];