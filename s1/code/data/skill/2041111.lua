SkillServerConfig[2041111]=
{
	...
	Leadtime = 0 ; --引导时间
	cdtype = 2041111 ; --CD类型，相同类型的技能共CD
	cd = 1 ; --CD时间
	sharecd = 0 ; --共享冷却类型
        ...
        [1]=
		{
			...
			bullets=
			{
				[1]=
				{
					...
					angle = 0; --扇形的角 扇形专用
					width = 4;--如果是矩形 radius 就是矩形人朝向方向的长度 width就是横向宽度
					bulletType = 4; --弹道类型（0直线弹道（默认值），1追踪弹道，2追踪群攻弹道（目标位置为原点），3弧形弹道，4固定弹道，用于一些服务器触发的技能）
...
thisconfig=SkillServerConfig[2041111];