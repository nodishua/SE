SkillServerConfig[1202]=
{
	id = 1202;
	name = "轻功";
	image = "";
	bubbleName = ds(230017);	--战斗冒字技能名称
	--攻击位移
	shiftmove = 6;--位移距离 负数就是往后咯
	shifttime = 0.3;--位移时间
	...
	--其他字段----------------------------------------------------------------------------
	Skill_list= 3 ;   --0、不属于任何技能列表|1血脉主动技能|2招式技能|3公用技能|4法球技能|5法器技能|6普通攻击技能
...
thisconfig=SkillServerConfig[1202];