		...
		[1]={			--警戒弹道
            ...
            bullets=
            {
                [1]=
                {
                    ...
                    originDistance = -4.5; --弹道原点离释放者多远 近战一般都是0
					originRotation = 90; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
                    regionType = 3; --1扇形 2圆形 3矩形
                    radius = 6; --半径 圆形扇形区域用到的，矩形的话就是长度
                    angle = 0; --扇形的角 扇形专用
...
thisconfig=SkillServerConfig[21029];