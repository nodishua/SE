		...
		[2]={
			...
			bullets=
			{
				...
				[2]=
				{
					...
					singleTargetHitMax = 8; --这个弹道能对单个单位造成多少次伤害
					singleTargetHitInterval = 2; --单个目标被击间隔;
					maxhit = 10; --弹道最多命中的目标数量
					shiftmove = 0;--被击位移距离
					shifttime = 0;--位移时间 --客户端用
					shiftrotation = 0; --位移默认方向是从施法者到被击者连线方向 加个旋转参数，角度、顺时针正数，逆时针负数
...
thisconfig=SkillServerConfig[21044];