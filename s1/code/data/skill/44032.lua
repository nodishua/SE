SkillServerConfig[44032]=
{
	...
	{			
		...
		};
		{
			...
			npctype=8002535;	--npctype和npcname如果配了的话，就走半身像飞入的说话方式，如果没配的话就走头上冒泡泡的方式
			npcname=ds(230263);
			dialog=ds(230208);
			offsettime=0;
			lifetime=2;
...
thisconfig=SkillServerConfig[44032];