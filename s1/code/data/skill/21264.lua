SkillServerConfig[21264]=
{
    ...
    --autoChooseDistanceMax = 3; --这里就配第一个弹道的originDistance就行了，并且弹道特效配置在弹道中，不配置在释放处
	
  --其他字段----------------------------------------------------------------------------
	Skill_list= 0 ;   --0、不属于任何技能列表|1血脉主动技能|2主动技能|3公共技能|4被动技能|5攻击触发法球技能|6被攻触发法球技能
		...
		[1]={
			...
			bullets=
			{
				[1]=
				{
					...
					singleTargetHitMax = 2; --这个弹道能对单个单位造成多少次伤害
					...
					mapEffect =				--预警配置
					{
						...
						scale = Vector3.New(3,1,10);		--缩放比例，扇形和圆形直接配缩放的值大小，矩形需要配=Vector3.New(x,1,z)x是横向，z是竖向，y不用管
						timeScale = 1/2.0;  --预警的播放速率，要是持续时间的倒数
					};
					appears= --这个弹道被打倒的表现
					{
						{
...
thisconfig=SkillServerConfig[21264];