	...
	{
		 {
		 	...
		 	lifetime=2;
		 	animation="skill01";
			baseSpeed = 0.5;	--暂时只关联了动作速率,以后关联攻速, 在动作的lifeTime结束的时候,才会还原到1
		 };
	};
	------------------------------------------------------------------------------------------
...
thisconfig=SkillServerConfig[22045];