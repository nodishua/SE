SkillServerConfig[22077]=
{
	...
	autoChooseDistance = 2; --自动选怪的最远距离
		...
		[1]=
		{
			...
			bullets=
		    {
				[1]=
				{
					...
					moveTime = 1; --弹道运行时间
					moveDistance = 3; --弹道运行长度 如果是0 表示在原点不动
		...
		[2]=
		{
			...
			bullets=
			{
				[1]=
				{
					...
					moveRotation = 45; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
					moveTime = 1; --弹道运行时间
					moveDistance = 3; --弹道运行长度 如果是0 表示在原点不动
		...
		[4]=
		{
			...
			bullets=
			{
				[1]=
				{
					...
					moveRotation = 135; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
					moveTime = 1; --弹道运行时间
					moveDistance = 3; --弹道运行长度 如果是0 表示在原点不动
		...
		[6]=
		{
			...
			bullets=
			{
				[1]=
				{
					...
					moveRotation = 225; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
					moveTime = 1; --弹道运行时间
					moveDistance = 3; --弹道运行长度 如果是0 表示在原点不动
		...
		[7]=
		{
			...
			bullets=
			{
				[1]=
				{
					...
					moveRotation = 270; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
					moveTime = 1; --弹道运行时间
					moveDistance = 3; --弹道运行长度 如果是0 表示在原点不动
		...
		[8]=
		{
			...
			bullets=
			{
				[1]=
				{
					...
					moveRotation = 315; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
					moveTime = 1; --弹道运行时间
					moveDistance = 3; --弹道运行长度 如果是0 表示在原点不动
...
thisconfig=SkillServerConfig[22077];