		...
		[4]={
            ...
            bullets=
            {
                [1]=
                {
                    ...
                    moveTime = 4.2; --弹道运行时间
                    moveDistance = 0.1; --弹道运行长度 如果是0 表示在原点不动
		...
		[5]={
            ...
            bullets=
            {
				...
				[2]=
                {
                    ...
                    moveRotation = 0; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
                    moveTime = 2; --弹道运行时间
                    moveDistance =-45; --弹道运行长度 如果是0 表示在原点不动
                    singleTargetHitMax = 1; --这个弹道能对单个单位造成多少次伤害
					singleTargetHitInterval = 1; --单个目标被击间隔;
                    maxhit = 10; --弹道最多命中的目标数量
                    shiftmove = 0;--被击位移距离
		...
		[6]={
            ...
            bullets=
            {
                [1]=
                {
                    ...
                    moveRotation = 45; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
                    moveTime = 1.2; --弹道运行时间
                    moveDistance = 5; --弹道运行长度 如果是0 表示在原点不动
                    singleTargetHitMax = 1; --这个弹道能对单个单位造成多少次伤害
					singleTargetHitInterval = 1; --单个目标被击间隔;
                    maxhit = 10; --弹道最多命中的目标数量
                    shiftmove = 0;--被击位移距离
...
thisconfig=SkillServerConfig[21248];