SkillServerConfig[21103]=
{
    id = 21103;
    name = "野猪冲锋";
    image = "";
    --攻击位移
    shiftmove = 5;--被击位移距离 负数就是往后咯
    shifttime = 1;--位移时间
		...
		[1]=
		{
            ...
            bullets=
            {
                [1]=
                {
                    ...
                    angle = 0; --扇形的角 扇形专用
					width = 2.5;--如果是矩形 radius 就是矩形人朝向方向的长度 width就是横向宽度 
                    ...
                    shiftmove = 1;--被击位移距离
					shifttime = 0.5;--位移时间 --客户端用
                    shiftrotation = 0; --位移默认方向是从施法者到被击者连线方向 加个旋转参数，角度、顺时针正数，逆时针负数
					affect_ID = 211031;	--弹道效果
					movelimit =  0.8, --行动硬直
					attacklimit = 0.8,--攻击硬直
					mapEffect =
						{
...
thisconfig=SkillServerConfig[21103];