...
SkillServerConfig[21023]=
{
	...
	shifttime = 0.8;--位移时间
	shiftoffset = 2; --释放多久后开始位移 --这个服务器忽略可以， 直接一放技能就到目标点
	
	movelimit =  3.3, --行动硬直
	attacklimit = 3.3,--攻击硬直
...
thisconfig=SkillServerConfig[21023];