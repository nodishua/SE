SkillServerConfig[1001]=
{
	...
	autoBlinkMinDistance = 1.5 ;
	autoBlinkLeftDistance = 1.5; --滚到离敌人多远
	autoBlinkAnimation = "skill03";
	autoBlinkAnimationTime = 0.1;
		...
		[1]=
		{
			...
			bullets=
			{
				[1]=	--追踪弹道，只对玩家生效
				{
					...
					originDistance = -0.01; --弹道原点离释放者多远 近战一般都是0
...
thisconfig=SkillServerConfig[1001];