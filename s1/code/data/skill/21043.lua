			...
			[1]=
				{
					...
					originRotation = 20; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
					...
					mapEffect =				--预警配置
					{
						...
						scale = Vector3.New(2.5,1,12);		--缩放比例，扇形和圆形直接配缩放的值大小，矩形需要配=Vector3.New(x,1,z)x是横向，z是竖向，y不用管
...
thisconfig=SkillServerConfig[21043];