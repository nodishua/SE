SkillServerConfig[22031]=   --技能ID
{
    ...
    autoChooseDistanceMax = 20; --这里就配第一个弹道的originDistance就行了，并且弹道特效配置在弹道中，不配置在释放处
	...
	{
		{
			...
			offsettime=0.0;
			lifetime=2;	--若lifetime短于真实动作时间，则动作会被截断
			animation="skill01";  --抬手做出召唤的动作
...
thisconfig=SkillServerConfig[22031];