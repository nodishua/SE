SkillServerConfig[500201]=
{
	Max_Level=10;
	id = 500201;
	name = "瞬镖";
	image = "";
	bubbleName = ds(230040);	--战斗冒字技能名称
	--攻击位移
	shiftmove = 6.0;--位移距离 负数就是往后咯
	shifttime = 0.001;--位移时间
...
thisconfig=SkillServerConfig[500201];