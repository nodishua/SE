		...
		[1]={			--表现弹道
			...
			bullets=
			{
				[1]=
				{
					...
					originDistance = 10.3; --弹道原点离释放者多远 近战一般都是0
...
thisconfig=SkillServerConfig[21293];