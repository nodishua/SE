		...
		[1]={
            ...
            bullets=
            {
                [1]=
                {
                    ...
                    originDistance = 0.7; --弹道原点离释放者多远 近战一般都是0
...
thisconfig=SkillServerConfig[11015];