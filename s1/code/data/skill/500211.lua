SkillServerConfig[500211]=
{
	Max_Level=10;
	id = 500211;
	name = "真凤";
	image = "";
	bubbleName = ds(230050);	--战斗冒字技能名称
	--攻击位移
	shiftmove = 7;--被击位移距离 负数就是往后咯
	shifttime = 0.3;--位移时间
	shiftoffset = 5.0; --释放多久后开始位移 --这个服务器忽略可以， 直接一放技能就到目标点
	movelimit =  6, --行动硬直
	attacklimit = 6,--攻击硬直
	svrattacklimit = 5,  --服务器用到的攻击硬直
    ...
    {1800,2600,3400,4200,5000,6000,7000,8000,9000,10000};
...
thisconfig=SkillServerConfig[500211];