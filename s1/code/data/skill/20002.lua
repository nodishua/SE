...
SkillServerConfig[20002]=
{
    ...
    autoChooseDistanceMax = 100; --这里就配第一个弹道的originDistance就行了
	...
	hits={
		...
		[2]={			--实际伤害弹道，对对面的圆形AOE
            ...
            bullets=
            {
                ...
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 100; --弹道原点离释放者多远 近战一般都是0
					originRotation = 0; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
                    regionType = 2; --1扇形 2圆形 3矩形
...
thisconfig=SkillServerConfig[20002];