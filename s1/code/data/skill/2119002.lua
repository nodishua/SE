...
SkillServerConfig[2119002]=
{
    ...
    shifttime = 0.25;--位移时间
    shiftoffset = 0.78; --释放多久后开始位移 --这个服务器忽略可以， 直接一放技能就到目标点
	...
	autoChooseDistance = 5; --自动选怪的最远距离
...
thisconfig=SkillServerConfig[2119002];