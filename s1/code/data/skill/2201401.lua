SkillServerConfig[2201401]=
{
    id = 2201401;
    name = "魔将·魔童—双轮齐飞readbar";
    image = "";
    --攻击位移
  ...
  --其他字段----------------------------------------------------------------------------
    ...
    Leadtime = 0 ; --引导时间
    cdtype = 2201401 ; --CD类型，相同类型的技能共CD
    cd = 0 ; --CD时间
    sharecd = 0 ; --共享冷却类型
					...
					mapEffect =
						{
							offset = 0;
							lifetime = 1;
							id = 9999992; --预警特效：30度扇形9999991，45度扇形9999992，90度扇形9999993，圆形9999994，矩形9999995
							scale = 12;
							rotation = -45;
						};
					appears= --这个弹道被打倒的表现
...
thisconfig=SkillServerConfig[2201401];