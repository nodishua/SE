SkillServerConfig[21270]=
{
	...
	movelimit =  6; --行动硬直
	attacklimit = 6;--攻击硬直
	svrmovelimit = 6,  --服务器用到的行动硬直
	svrattacklimit = 6,  --服务器用到的行动硬直

	--客户端专用----------------------------------------------------------------------------
	autoChooseTarget = true; --自动选怪的方向
    autoChooseDistance = 50; --自动选怪的最远距离
	autoBlink = true; -- 近战的普通攻击 在单人副本的时候 自动瞬移到怪面前去
	autoBlinkMaxDistance = 10; 
	...
	autoChooseDistanceMax = 50; --这里就配第一个弹道的originDistance就行了
		...
		[1]={			--预警弹道
			...
			bullets=
			{
				[1]=
				{
					...
					originDistance = 50; --弹道原点离释放者多远 近战一般都是0
...
thisconfig=SkillServerConfig[21270];