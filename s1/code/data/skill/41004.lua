SkillServerConfig[41004]=
{
	...
	svrmovelimit = 0.9,  --服务器用到的行动硬直
	svrattacklimit = 1.1,  --服务器用到的行动硬直
	baseSpeed = 1.3;
	skillDirInfo = 
	{
...
thisconfig=SkillServerConfig[41004];