...
SkillServerConfig[2200402]=
{
	...
	--攻击位移
	shiftmove = 1;--施法者位移距离 负数就是往后咯
	shifttime = 0.2;--位移时间
	shiftoffset = 0.2+readtime; --释放多久后开始位移 --这个服务器忽略可以， 直接一放技能就到目标点
...
thisconfig=SkillServerConfig[2200402];