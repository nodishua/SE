	...
	hits={
		...
		[2]={			--伤害弹道，预警特效出现之后，等下出黑暗手和伤害
            ...
            bullets=
            {
                [1]=
                {
					...
					originRotation = -75; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
                    regionType = 2; --1扇形 2圆形 3矩形
		...
		[10]={			--伤害弹道，预警特效出现之后，等下出黑暗手和伤害
            ...
            bullets=
            {
                ...
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 1.54; --弹道原点离释放者多远 近战一般都是0
		...
		[11]={			--伤害弹道，预警特效出现之后，等下出黑暗手和伤害
			offset=5.4; --技能释放后多久生效
            --弹道数据
            bullets=
            {
                [1]=
		...
		[12]={			--伤害弹道，预警特效出现之后，等下出黑暗手和伤害
            ...
            bullets=
            {
                [1]=
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 2; --弹道原点离释放者多远 近战一般都是0
					originRotation = -50; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
                    regionType = 2; --1扇形 2圆形 3矩形
                    ...
                    singleTargetHitMax = 5; --这个弹道能对单个单位造成多少次伤害
				...
				[3]=
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 7; --弹道原点离释放者多远 近战一般都是0
					originRotation = -12; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
                    regionType = 2; --1扇形 2圆形 3矩形
                    radius = 1.5; --半径 圆形扇形区域用到的
                    angle = 0; --扇形的角 扇形专用
					width = 0;--如果是矩形 radius 就是矩形人朝向方向的长度 width就是横向宽度 
                ...
                {
                    effectid = 0; --特效id 客户端专用
                    originDistance = 12.5; --弹道原点离释放者多远 近战一般都是0
					originRotation = -8; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
                    regionType = 2; --1扇形 2圆形 3矩形
                    radius = 1.5; --半径 圆形扇形区域用到的
                    angle = 0; --扇形的角 扇形专用
					width = 0;--如果是矩形 radius 就是矩形人朝向方向的长度 width就是横向宽度 
...
thisconfig=SkillServerConfig[21054];