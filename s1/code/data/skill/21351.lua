...
SkillServerConfig[21351]=   --技能ID
{
	...
	svrmovelimit = 3.5,  --服务器用到的行动硬直
	svrattacklimit = 3.5,  --服务器用到的行动硬直
	skillDirInfo = 
	{
	...
	{
		{
			...
			offsettime=0.0;
			lifetime=3.5;	--若lifetime短于真实动作时间，则动作会被截断
			animation="skill02";
...
thisconfig=SkillServerConfig[21351];