		...
		[1]=
		{
            ...
            bullets=
            {
                [1]=
                {
                    ...
                    originDistance = -1.75; --弹道原点离释放者多远 近战一般都是0
					...
					singleTargetHitInterval = 0.6; --单个目标被击间隔;
                    maxhit = 10; --弹道最多命中的目标数量
                    shiftmove = 0;--被击位移距离
					shifttime = 0;--位移时间 --客户端用
                    shiftrotation = 0; --位移默认方向是从施法者到被击者连线方向 加个旋转参数，角度、顺时针正数，逆时针负数
					affect_ID = 320031;	--弹道效果
					movelimit =  0, --行动硬直
					attacklimit = 0,--攻击硬直
					appears= --这个弹道被打倒的表现
	                {
...
thisconfig=SkillServerConfig[32003];