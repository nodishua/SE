...
SkillServerConfig[21189]=
{
	...
	shifttime = 0.15;--位移时间
	shiftoffset = 1.5; --释放多久后开始位移 --这个服务器忽略可以， 直接一放技能就到目标点

	
	movelimit = 2.3, --行动硬直
	attacklimit = 2.3,--攻击硬直
	baseSpeed = 0.5;
  ...
  --------------------------------------------------------------------------------------
	appears= --释放表现
	{
		...
		{
			offsettime = 0;
			lifetime = 1.50;	--预警的播放时间，要和技能真实出现对应
			id = 9999995;			--预警的特效ID，要配主任特殊处理过的9999991——9999995
			scale = Vector3.New(8,1,10);		--缩放比例，扇形和圆形直接配缩放的值大小，矩形需要配=Vector3.New(x,1,z)x是横向，z是竖向，y不用管
		...
		
		{
			...
			lifetime=0.3;
			interval = 0.03;
			lifeCycle = 0.2;	-- lifeCycle / interval 不要大于10
...
thisconfig=SkillServerConfig[21189];