SkillServerConfig[42032]=
{
    ...
    movelimit =  1, --行动硬直
    attacklimit = 1;	--1 / SkillServerConfig[2032].baseSpeed ,--攻击硬直
	svrmovelimit = 1,  --服务器用到的行动硬直
	svrattacklimit = 1; --1 / SkillServerConfig[2032].baseSpeed ,  --服务器用到的行动硬直
	...
	appears =
	{
		...
		};
		{
			...
			npctype=8002515;	--npctype和npcname如果配了的话，就走半身像飞入的说话方式，如果没配的话就走头上冒泡泡的方式
			npcname=ds(230239);
			dialog=ds(230182);
			offsettime=0;
			lifetime=2;
...
thisconfig=SkillServerConfig[42032];