...
SkillServerConfig[0]=   --技能ID
{
    ...
    autoChooseDistance = 8.5; --自动选怪的最远距离;人物技能: 自动去选择怪物;怪物技能: 作为该技能的施法距离
	...
	chooseFriend = true;	--该技能是否以友方角色为释放目标（针对于非追踪弹道的）
	--其他字段----------------------------------------------------------------------------
...
thisconfig=SkillServerConfig[0];