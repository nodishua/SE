		...
		[1]={			--预警弹道
			...
			bullets=
			{
				[1]=
				{
					...
					{
						offset = 0;
						lifetime = 2.5;	--预警的播放时间，要和技能真实出现对应
						id = 9999994;			--预警的特效ID，要配主任特殊处理过的9999991——9999995
						scale = 20;		--缩放比例，扇形和圆形直接配缩放的值大小，矩形需要配=Vector3.New(x,1,z)x是横向，z是竖向，y不用管
					};
					appears= --这个弹道被打倒的表现
					{
					};
...
thisconfig=SkillServerConfig[22018];