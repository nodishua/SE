...
SkillServerConfig[44011]=
{
	...
	svrmovelimit = 1.0,  --服务器用到的行动硬直
	svrattacklimit = 1.2,  --服务器用到的行动硬直
...
--其他字段----------------------------------------------------------------------------
	...
	appears= --释放表现
	{
		...
		};
		{
			...
			npctype=8002571;	--npctype和npcname如果配了的话，就走半身像飞入的说话方式，如果没配的话就走头上冒泡泡的方式
			npcname=ds(230222);
			dialog=ds(230201);
			offsettime=0;
			lifetime=2;
...
thisconfig=SkillServerConfig[44011];