...
SkillServerConfig[21352]=   --技能ID
{
    id = 21352; --技能ID
    name = "篝火光环-结婚副本2"; -- 技能名称
    image = ""; -- 技能图标
    ...
    autoChooseDistance = 20; --自动选怪的最远距离;人物技能: 自动去选择怪物;怪物技能: 作为该技能的施法距离
...
thisconfig=SkillServerConfig[21352];