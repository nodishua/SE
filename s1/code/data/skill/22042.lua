	...
	{
		{
			...
			offsettime=0;
			lifetime=6;	--若lifetime短于真实动作时间，则动作会被截断
			animation="skill03";
...

		{
			...
			npctype=9001162;	--npctype和npcname如果配了的话，就走半身像飞入的说话方式，如果没配的话就走头上冒泡泡的方式
			npcname=ds(230217);
			dialog=ds(230140);
			offsettime=0.5;
			lifetime=5;
...
thisconfig=SkillServerConfig[22042];