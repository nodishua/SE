SkillServerConfig[500213]=
{
	Max_Level=10;
    id = 500213;
    name = "断碑";
    image = "";
	bubbleName = ds(230097);	--战斗冒字技能名称
    --攻击位移
	...
	castDistance = 4;	--主角技能需要，释放技能需要跟目标距离，在这个距离内会放技能，否则要走过去，摇杆不局限在这个管制下
...
thisconfig=SkillServerConfig[500213];