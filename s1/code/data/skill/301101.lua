SkillServerConfig[301101]=
{
	id = 301101;
	Max_Level=75;
	name = "势如破竹";
	image = "";
	--bubbleName = "势如破竹";	--战斗冒字技能名称
	--攻击位移
	shiftmove = 8;--被击位移距离 负数就是往后咯
	shifttime = 0.2;--位移时间
	shiftoffset = 0.05,--0.9; --释放多久后开始位移 --这个服务器忽略可以， 直接一放技能就到目标点
	movelimit =  0.4, --行动硬直
	...
	GetShiftPos = function()
		return LOCAL_CHAR.skill3011pos;
	end;
	
	--段
	hits={
		[1]={	--冲锋无敌
			offset=0.05; --技能释放后多久生效
			--弹道数据
			bullets=
			{
				[1]=
...
thisconfig=SkillServerConfig[301101];