...
SkillServerConfig[301301]=
{
	Max_Level=75;
    id = 301301;
    name = "乾坤一掷B符文连招";
    image = "";
	masterskill = 3013; --连招技能用，填第一招的ID
    nextskill = 0; --连招技能用，填下一招的ID
    nextskilltime = 0; --连招技能用，指放下一招的时间长度
	combocount = 2;
	currcombo = 2;
    --攻击位移
    shiftmove = 7.5;--被击位移距离 负数就是往后咯
    shifttime = 0.4;--位移时间
    shiftoffset = 0.9; --释放多久后开始位移 --这个服务器忽略可以， 直接一放技能就到目标点
    movelimit =  1.4, --行动硬直
    attacklimit = 1.4,--攻击硬直
...
thisconfig=SkillServerConfig[301301];