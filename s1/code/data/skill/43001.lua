...
Max_Level=75;
	...
	baseSpeed = 1;
	movelimit =  0.55, --行动硬直
	attacklimit = 0.41,--攻击硬直
	svrmovelimit = 0.55,  --服务器用到的行动硬直
	svrattacklimit = 0.41,  --服务器用到的行动硬直
	...
	autoBlinkAnimationTime = 0.5;
	autoBlinkSpeed = 12; --速度
...
thisconfig=SkillServerConfig[43001];