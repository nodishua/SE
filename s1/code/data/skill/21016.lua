SkillServerConfig[21016]=
{
	...
	Leadtime = 0 ; --引导时间
	cdtype = 2045010 ; --CD类型，相同类型的技能共CD
	cd = 3 ; --CD时间
	sharecd = 0 ; --共享冷却类型
		...
		[13]={			--表现弹道，地面先出的冰漩涡特效
			...
			bullets=
			{
				[1]=
				{
					...
					originRotation = 35; --弹道原点与施法者面向的角度，顺时针正数，逆时针负数
					regionType = 2; --1扇形 2圆形 3矩形
					radius = 3; --半径 圆形扇形区域用到的
					angle = 0; --扇形的角 扇形专用
					moveRotation = 0; --移动方向 0表示 施法者的向量 其他表示这个向量旋转的角度，   顺时针正数 逆时针负数
...
thisconfig=SkillServerConfig[21016];