...
SkillServerConfig[22014]=
{
  ...
  --------------------------------------------------------------------------------------
	...
	--段
    readbar = 22014; --吟唱技能在readbar中的配置ID
	...
	hits={
		[1]={
			offset=0; --技能释放后多久生效
			barskillID = 2201401;	--0如果是读条技能则在此配子技能
            --弹道数据
            bullets=
            {
            };    
		...
		[2]={
			...
			barskillID = 2201401;	--如果是读条技能则在此配子技能
            --弹道数据
            bullets=
            {
            };    
...
thisconfig=SkillServerConfig[22014];