		...
		[1]={
            ...
            bullets=
            {
                [1]=
                {
					...
					bulletType = 1; --弹道类型（0直线弹道（默认值），1追踪弹道，2追踪群攻弹道（目标位置为原点），3弧形弹道，4固定弹道，用于一些服务器触发的技能）
                    moveTime = 1; --弹道运行时间
...
thisconfig=SkillServerConfig[21145];