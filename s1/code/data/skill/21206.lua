...
SkillServerConfig[21206]=   --技能ID
{
    id = 21206; --技能ID
    name = "驭灵墓牵引3M"; -- 技能名称
    image = "partner01_119"; -- 技能图标
    ...
    autoChooseDistance = 6; --自动选怪的最远距离;人物技能: 自动去选择怪物;怪物技能: 作为该技能的施法距离
	...
	--其他字段----------------------------------------------------------------------------
    Skill_list= 2 ;   --0、不属于任何技能列表|1血脉主动技能|2招式技能（每个职业的基础技能）|3公共技能|4法球技能|5法器技能|6普通攻击技能|7副本特殊技能
	...
	{
		{
			...
			offsettime=0.0;
			lifetime=1.2;	--若lifetime短于真实动作时间，则动作会被截断
			animation="attack01";
		...
		[1]={
            ...
            bullets=
            {
                [1]=
                {
					...
					mapEffect =
					{
                        moveDis = 6;    --不配置这个值,那么就是moveDistance
						offset = 0;
						lifetime = 4.50;
						id = 0;
						scale = 1.0;	----缩放比例
...
thisconfig=SkillServerConfig[21206];