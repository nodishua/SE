...
SkillServerConfig[23401]=   --技能ID
{
	...
	autoChooseDistanceMax = 9; --这里就配第一个弹道的originDistance就行了
	--其他字段----------------------------------------------------------------------------
	...
	{
		{
			...
			offsettime=0;
			lifetime=1;	--若lifetime短于真实动作时间，则动作会被截断
			animation="attack01";
...
thisconfig=SkillServerConfig[23401];