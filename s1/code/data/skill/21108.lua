SkillServerConfig[21108]=
{
  ...
  --------------------------------------------------------------------------------------
	...
	readbar = 21108; --吟唱技能在readbar中的配置ID
	readBarTime = 10; --吟唱技能在readbar中的吟唱时间
...
thisconfig=SkillServerConfig[21108];