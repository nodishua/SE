...
SkillServerConfig[21348]=   --技能ID
{
    ...
    movelimit =  5.5, --行动硬直
    attacklimit = 5.5,--攻击硬直
	svrmovelimit = 5.5,  --服务器用到的行动硬直
	svrattacklimit = 5.5,  --服务器用到的行动硬直
...
thisconfig=SkillServerConfig[21348];