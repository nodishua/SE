SkillServerConfig[3013]=
{
	Max_Level=75;
    id = 3013;
    name = "焰锋·酣畅";
    image = "";
	bubbleName = ds(230061);	--战斗冒字技能名称
	--攻击位移
    ...
    --[[OnLocalCast = function()
        ...
        local targetPos = pos + transform.forward * 7;
        ...
        LOCAL_CHAR.skill3011pos = targetPos;
...
thisconfig=SkillServerConfig[3013];