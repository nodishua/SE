...
SkillServerConfig[41101]=
{
    ...
    appears= --释放表现
	{
		...
		};
		{
			...
			npctype=8002581;	--npctype和npcname如果配了的话，就走半身像飞入的说话方式，如果没配的话就走头上冒泡泡的方式
			npcname=ds(230232);
			dialog=ds(230174);
			offsettime=0;
			lifetime=2;
...
thisconfig=SkillServerConfig[41101];