...
SkillServerConfig[21005]=
{
  ...
  --其他字段----------------------------------------------------------------------------
	...
	Leadtime = 0 ; --引导时间
	cdtype = 2022010 ; --CD类型，相同类型的技能共CD
	cd = 3 ; --CD时间
	sharecd = 0 ; --共享冷却类型
		...
		[1]={
			...
			bullets=
			{
				[1]=
				{
					...
					radius = 6.0; --半径 圆形扇形区域用到的；矩形为长度
					angle = 0; --扇形的角 扇形专用
					width = 4.5;--如果是矩形 radius 就是矩形人朝向方向的长度 width就是横向宽度
...
thisconfig=SkillServerConfig[21005];