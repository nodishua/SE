...
SkillServerConfig[21003]=
{
  ...
  --其他字段----------------------------------------------------------------------------
	...
	Leadtime = 0 ; --引导时间
	cdtype = 2011010 ; --CD类型，相同类型的技能共CD
	cd = 3 ; --CD时间
	sharecd = 0 ; --共享冷却类型
			...
			bullets=
			{
				[1]=
				{
					...
					mapEffect =				--预警配置
					{
						...
						scale =Vector3.New(3,1,8) ;		--缩放比例，扇形和圆形直接配缩放的值大小，矩形需要配=Vector3.New(x,1,z)x是横向，z是竖向，y不用管
...
thisconfig=SkillServerConfig[21003];