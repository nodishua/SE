...
SkillServerConfig[41032]=
{
	...
	movelimit =  0.45 / 1.5, --行动硬直
	attacklimit = 0.45 / 1.5,--攻击硬直
	svrmovelimit = 0.35,  --服务器用到的行动硬直
  ...
  --------------------------------------------------------------------------------------
	appears= --释放表现
	{
		...
		};
		{
			...
			npctype=8002505;	--npctype和npcname如果配了的话，就走半身像飞入的说话方式，如果没配的话就走头上冒泡泡的方式
			npcname=ds(230229);
			dialog=ds(230169);
			offsettime=0;
			lifetime=2;
...
thisconfig=SkillServerConfig[41032];